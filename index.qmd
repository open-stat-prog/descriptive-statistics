...
3. [Summarizing data with tidyverse](/tutorials/summarizing-data-tidy/index.qmd): How to calculate summary statistics for numeric data using tidyverse
4. [Frequency tables with tidyverse](/tutorials/frequency-tables-tidy/index.qmd): How to summarize categorical data using tidyverse
