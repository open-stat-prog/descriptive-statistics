...
*Non-standard missing values* are more difficult to find because `R` doesn’t know that they are missing. Depending on your research question, you may want to convert non-standard missing data responses to `NA` for smoother data manipulation. You may also decide that these types of responses are informative and that you want to keep them as they are.
