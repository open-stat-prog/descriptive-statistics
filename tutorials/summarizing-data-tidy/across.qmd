...
The `across()` helper allows us to do this in a compact and readable way. Here, `everything()` can be used to select all variables in the dataset, and subsequently `.x` is commonly used to refer back to either `everyting()` or any other selection of variables you might have made.
