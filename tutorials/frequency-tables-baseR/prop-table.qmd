...
If we now use the command prop.table() on theme.table, we will see the proportions of the themes. This indicates how large the share of each theme is (with a number between 0 and 1). 
